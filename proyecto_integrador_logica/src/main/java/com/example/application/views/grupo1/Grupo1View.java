...
public class Grupo1View extends VerticalLayout {
    ...
    public Grupo1View() {
        ...
        // // Algoritmo1
        // titulo1 = "Algoritmo 1";
        // titulo2 = "Calculadora Movimiento Circular Uniforme ";
        // descripcion = "El movimiento rectilíneo uniforme (MRU) es un tipo de movimiento en el cual un objeto se mueve en línea recta y a velocidad constante, es decir, su velocidad no cambia en el tiempo. En este tipo de movimiento, la trayectoria del objeto es una línea recta, por lo que su aceleración es cero.";
